      ...
      <div className="container mx-auto px-6 max-w-[1280px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {clients.map((cl, idx) => (
            <div 
              key={idx}
              className="bg-white p-6 rounded-[16px] border border-gray-200/70 shadow-sm hover:shadow-md hover:border-[#0A4EA3]/40 transition-all flex flex-col items-center justify-center text-center group"
            >
